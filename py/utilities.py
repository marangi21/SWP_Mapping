    ...
    with tqdm(total=num_epochs, desc="Training.. ", leave=False) as epoch_pbar:
        for epoch in range(num_epochs):
            ...
            if valid_loss < best_val_loss:
                ...
                torch.save(model.state_dict(), r'C:\Users\giova\OneDrive\Desktop\projects\SWP-regr\best_model.pt') 
                count = 0
            else:
...
def plot_best_losses(best_train_losses, best_val_losses, test_loss, early_stop_epoch):
    ...
    plt.legend()
    plt.savefig('C:\Users\giova\OneDrive\Desktop\projects\SWP-regr\loss_plot.png', dpi=300, bbox_inches='tight')
    plt.show()