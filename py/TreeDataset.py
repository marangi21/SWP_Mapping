...
class TreeDataset(Dataset):
  ...
  def __init__(self, mode, augment=False):
    ...
    if mode == 'train':
      data = pd.read_csv(r'C:\Users\giova\OneDrive\Desktop\projects\SWP-regr\data\train_set.csv', header=0)
    elif mode == 'val':
      data = pd.read_csv(r'C:\Users\giova\OneDrive\Desktop\projects\SWP-regr\data\val_set.csv', header=0)    
    elif mode == 'test':
      data = pd.read_csv(r'C:\Users\giova\OneDrive\Desktop\projects\SWP-regr\data\test_set.csv', header=0)   
    else:
